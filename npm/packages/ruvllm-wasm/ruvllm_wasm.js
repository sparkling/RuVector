...
class MicroLoraWasm {
     ...
     * @param {AdaptFeedbackWasm} feedback
     */
    adaptConstrained(input, feedback) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayF32ToWasm0(input, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            _assertClass(feedback, AdaptFeedbackWasm);
            wasm.microlorawasm_adaptConstrained(retptr, this.__wbg_ptr, ptr0, len0, feedback.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_hardwareConcurrency_82768dee2474b5b4: function(arg0) {
        ...
        __wbg_new_74c717698bebebf1: function(arg0) {
        ...
        __wbg_new_9f3f48c9d5ca68f4: function(arg0) {
        ...
        __wbg_set_f4c4f045fb734741: function(arg0, arg1, arg2) {
            getObject(arg0).set(getObject(arg1), arg2 >>> 0);
        },
        ...
        __wbg_terminate_a18ca09528ba9003: function(arg0) {
