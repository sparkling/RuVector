...
// Re-export WASM module for advanced usage (built by `npm run build:wasm`)
// @ts-ignore — dist/wasm is generated; stub lives here so tsc type-checks cleanly
...
export class RvLite {
  ...
  async init(): Promise<void> {
    ...
    // @ts-ignore — dist/wasm is generated by wasm-pack; not present at type-check time
