//! Shared EWC++ (Elastic Weight Consolidation) core: Fisher-information catastrophic-forgetting protection. Extracted from crates/sona/src/ewc.rs per ADR-0231 to enable sharing with crates/ruvllm-wasm.
//!
